...
_C.MODEL.BACKBONE.EXTRAS = [256, 'S', 512, 128, 'S', 256, 128, 256, 128, 256]
_C.MODEL.BACKBONE.CONV6_SIGMA = False
...
_C.TEST.RESCALE_FACTOR = 0.0

_C.OUTPUT_DIR = 'outputs'
_C.RESUME_FROM_EXPERIMENT = ""
_C.FOO = 1
