...
def inference(model, data_loader, dataset_name, device, output_folder=None, use_cached=False, **kwargs) -> Dict[str, float]:
...
@torch.no_grad()
def do_evaluation(cfg, model, distributed, **kwargs) -> List[Dict[str, float]]:
