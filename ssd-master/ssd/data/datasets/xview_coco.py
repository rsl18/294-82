...
class XVIEWCOCODataset(torch.utils.data.Dataset):
    # Commenting this out, would rather not have to hardcode something like this. So far
    # training seems to work OK and I did a search through the project and couldn't find
    # anything that references this variable:
