...
from .remap import update_mapping
import copy
import json
import time
...
class COCO:
    def __init__(self, annotation_file=None, create_mapping=False, mapping_csv=None, write_to_JSON=None):
        """
    ...
    def getAnnIds(self, imgIds=[], catIds=[], areaRng=[], iscrowd=None): #NOT
        """
